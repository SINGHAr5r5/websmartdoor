      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="./add_bill.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">เพิ่มข้อมูลสมาชิกใหม่</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">เพิ่มข้อมูลสมาชิกใหม่</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <div class="col-md-6">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">กรอกข้อมูลสมาชิกใหม่</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" name="member" action="add_member.php?key=1" method="POST" enctype="multipart/form-data">                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="pass" name="pass" placeholder="กรอกข้อมูลตรงนี้">
                  </div>
                  <div class="row">
                   <div class="col-md-6 form-group">
                    <label for="exampleInputPassword1">เบอร์โทรศัพท์</label>
                    <input type="text" class="form-control" id="phone_user" name="phone_user" placeholder="กรอกข้อมูลตรงนี้">
                  </div>
                  <div class="col-md-6 form-group">
                  ...
                  <div class="form-group">
                    <label for="exampleInputFile">รูปสมาชิก</label>
                ...
                <button type="submit" class="btn btn-primary" onclick="myFunction()">บันทึก</button>
                </div>
              </form>
            </div>
