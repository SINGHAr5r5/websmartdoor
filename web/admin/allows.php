  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
          <div class="row">
      <?php
              $bill_sql = "SELECT * FROM add_bill order by room ASC";
              ...
              ?>
      <div class="col-lg-4">
      <?php if (isset($bill_row["status_bill"]) and $bill_row["status_bill"] == '1') { ?>
            <div class="card card-primary card-outline" style="background: red">
              <div class="card-header">
                <h5 class="card-title m-0">ห้อง  <?php echo $bill_row["room"]; ?> </h5>
              </div>
              <div class="card-body">
              <select class="form-control">
              <option><?php echo $bill_row["status_bill"]; ?></option>
              <option>2</option>
              <option>3</option>
                        </select>
            ...
            <?php 
                }else if(isset($bill_row["status_bill"]) and $bill_row["status_bill"] == '2'){ ?>
                 <div class="card card-primary card-outline" style="background: yellow ">
              <div class="card-header">
                <h5 class="card-title m-0">ห้อง  <?php echo $bill_row["room"]; ?> </h5>
            ...
            <?php }else if(isset($bill_row["status_bill"]) and $bill_row["status_bill"] == '3'){ ?>
                <div class="card card-primary card-outline" style="background: green">
              <div class="card-header">
                <h5 class="card-title m-0">ห้อง  <?php echo $bill_row["room"]; ?> </h5>
              </div>
              <div class="card-body">
