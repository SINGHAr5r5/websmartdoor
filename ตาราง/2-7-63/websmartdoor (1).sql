...
INSERT INTO `add_bill` (`id_bill`, `room`, `user`, `bill_old`, `electricity_bill`, `mitor`, `water_bill`, `member_bill`, `date_add`, `date_pay`, `status_bill`, `date_m`) VALUES
(51, '101', 'สิงหา  ดวงแก้ว', '00000000', '00000010', '10', '100', '33', '2020-07-01', '2020-07-02', '1', '07'),
...
CREATE TABLE `send_money` (
  ...
  `img_send` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `send_money` (`id_send`, `user`, `room`, `month_send`, `date_bill`, `img_send`, `status_send`) VALUES
(41, 'สิงหา  ดวงแก้ว', '101', '51', '2020-07-02', 'img_02072020094700_sen.PNG', '1');
...
--
ALTER TABLE `send_money`
  MODIFY `id_send` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
