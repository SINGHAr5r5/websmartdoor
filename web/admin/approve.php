        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="./approve.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>อนุมัติการชำระเงิน</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">อนุมัติการชำระเงิน</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">อนุมัติการชำระเงิน</h3>
        ...
        <div class="card-body p-0">
          <table class="table table-striped projects">
              ...
              <tbody>
              <?php 
              $sql = "SELECT * FROM send_money  where status_send='1'";
$result_showbill = $conn->query($sql);

if ($result_showbill->num_rows > 0) {
  // output data of each row
  while($row_showbill = $result_showbill->fetch_assoc()) {
...
" >
                      ...
                      <td >
                          ...
                          <button class="button">อนุมัติ</button>
                            </form>
                          ...
                          <button class="button button3">ไม่อนุมัติ</button>
                            </form>
                      </td>
                  </tr>
  <?php } } ?>
